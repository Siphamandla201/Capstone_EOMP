            ...
            <div class="women-hero-section">
                <a href="#" class="women-hero-container">
                    <div class="women-hero-bg-2">
                        ...
                        <h4>
                            The shape of things: new Balenciaga is here
                        </h4>
                        <p>
                            Exaggerated silhouettes. Dramatic proportions. Fluid lines — the new collection from Balenciaga has arrived. We take a deep-dive into the highlights
                        </p>
                        </div>
                    </div>
                </a>

<template>
  <div class="products-holder">
    <div class="Home">
      ...
      <div v-if="displayedProducts.length === null" class="loading-spinner">
        <Spinner />
      </div>
    </div>
  </div>
...
export default {
  ...
  setup() {
    ...
    const products = store.state.products || []; // Use an empty array as a default value if products is null or undefined
